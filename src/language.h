...
const char CLI_HELP_ATTACK[] PROGMEM = "attack [beacon] [deauth] [deauthall] [probe] [truedeauth] [eviltwin] [nooutput] [-t <timeout>]";
const char CLI_HELP_ATTACK_STATUS[] PROGMEM = "attack status [<on/off>]";
const char CLI_HELP_TRUE_DEAUTH[] PROGMEM = "attack truedeauth [-d]";
const char CLI_HELP_EVIL_TWIN[] PROGMEM = "attack eviltwin [ssid]";
...
const char D_TRUE_DEAUTH[] PROGMEM = "TRUE DEAUTH";
...
const char A_EVIL_TWIN_START[] PROGMEM = "Evil Twin attack started";
const char A_TRUE_DEAUTH_START[] PROGMEM = "True Deauth attack started";
...
const char W_STATUS_OK[] PROGMEM = " OK";
