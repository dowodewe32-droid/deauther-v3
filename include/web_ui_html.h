...
".card{background:#1e293b;border-radius:12px;padding:20px;margin-bottom:15px}.card h2{color:#a78bfa;margin-bottom:15px}"
...
".status-on{background:#22c55e}.info{background:#334155;padding:10px;border-radius:8px;margin-top:10px}table{width:100%}"
"th,td{padding:10px;border-bottom:1px solid #334155;text-align:left}th{color:#a78bfa}</style></head>"
"<body>"
"<div class=\"header\"><h1>GMpro87dev</h1><p>Full Features: Deauth + Beacon</p></div>"
"<div class=\"card\"><h2>WiFi Scanner</h2><button class=\"btn btn-primary\" onclick=\"scanWiFi()\">Scan</button>"
"<div id=\"scanResult\" class=\"info\">Tap scan</div></div>"
"<div class=\"card\"><h2>Deauth Attack</h2><p>Sent: <span id=\"deauthCount\">0</span></p>"
...
"<div class=\"card\"><h2>Beacon Spam</h2><p>Status: <span id=\"beaconStatus\" class=\"status\">OFF</span> | Frames: <span id=\"beaconCount\">0</span></p>"
